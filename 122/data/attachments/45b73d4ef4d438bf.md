...
- Name: admin.spec.ts >> Admin Panel E2E >> should cancel rejection when dismiss is clicked on prompt
- Location: tests/e2e/admin.spec.ts:266:7
...
Call log:
  - navigating to "http://127.0.0.1:8080/admin.html", waiting until "load"
