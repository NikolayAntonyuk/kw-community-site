...
- Name: crm.spec.ts >> CRM Panel E2E >> should display emails from API
- Location: tests/e2e/crm.spec.ts:164:7
...
Call log:
  - waiting for locator('a:has-text("✉️")')
    - locator resolved to <a class="tab-btn" onclick="switchTab('email')">✉️ Пошта</a>
