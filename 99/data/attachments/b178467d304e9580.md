...
- Name: admin.spec.ts >> Admin Panel E2E >> (@T19) should display email badge with unread count
- Location: tests/e2e/admin.spec.ts:356:7
...
Locator:  locator('.email-badge-count')
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.email-badge-count')
    14 × locator resolved to <span id="email-unread-count" class="email-badge-count">5</span>
