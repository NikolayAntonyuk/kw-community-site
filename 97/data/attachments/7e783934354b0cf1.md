  ...
  - main [ref=e10]:
    ...
    - generic [ref=e20]:
      - generic [ref=e21]:
        ...
        - generic [ref=e25] [cursor=pointer]: ✉️ Пошта
        - generic [ref=e26] [cursor=pointer]: Архів заявок
        - generic [ref=e27] [cursor=pointer]: Архів каталогу
      - generic [ref=e28]:
        - heading "Нові заявки" [level=2] [ref=e30]
        - generic [ref=e31]: Завантаження...
```
...
> 678 |     expect(tabCount).toBe(5);
  ...
  748 | 
  749 |     // Verify all form fields are accessible
  750 |     await expect(page.locator('#edit-name')).toBeVisible();
  751 |     await expect(page.locator('#edit-category')).toBeVisible();
  752 |     await expect(page.locator('#edit-phone')).toBeVisible();
  753 |   });
  754 | });
  755 | 
```