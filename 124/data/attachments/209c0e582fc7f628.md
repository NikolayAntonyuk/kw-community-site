...
- Name: admin-email-features.spec.ts >> Email Features & Admin Panel (New Requirements) >> @T3 should display correct form fields in inaccuracy report modal
- Location: tests/e2e/admin-email-features.spec.ts:68:7
...
- navigation:
  ...
  - link "Школа":
    - /url: school.html
- complementary:
  - heading "Адмін панель" [level=2]
  - button "✕"
  - list:
    - listitem:
      - button "📋 Нові заявки"
    - listitem:
      - button "👥 Живий каталог"
    - listitem:
      - button "🐛 Звіти про помилки"
    - listitem:
      - button "📁 Архів"
    - listitem:
      - button "✉️ Пошта"
