...
- Name: crm.spec.ts >> CRM Panel E2E >> should show error on wrong credentials
- Location: tests/e2e/crm.spec.ts:16:7
...
Call log:
  - waiting for locator('#loginEmail')
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - heading "⚡ KW CRM" [level=2] [ref=e4]
    - generic [ref=e5]:
      - generic [ref=e6]: Email
      - textbox "admin@example.com" [ref=e7]
    - generic [ref=e8]:
      - generic [ref=e9]: Пароль
      - textbox "••••••••" [ref=e10]
    - button "Увійти" [ref=e11] [cursor=pointer]
  - generic [ref=e12]:
    - generic [ref=e13]: ✅ Firebase модулі завантажені успішно!
    - generic [ref=e14]: ❌ Користувач не авторизований
```
