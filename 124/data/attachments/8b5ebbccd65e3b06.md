...
- Name: admin-email-features.spec.ts >> Email Features & Admin Panel (New Requirements) >> @T2 should display "Report Inaccuracy" button when modal is opened
- Location: tests/e2e/admin-email-features.spec.ts:47:7
