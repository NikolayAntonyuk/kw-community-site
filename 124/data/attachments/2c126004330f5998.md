...
- Name: error-reports.spec.ts >> Error Reports Requirements (Звіти про помилки) >> @T10 Admin should see an auxiliary field with suggested changes and copy button when editing a report
- Location: tests/e2e/error-reports.spec.ts:71:7
  ...
  - navigation [ref=e2]:
    ...
    - generic [ref=e6]:
      ...
      - link "Школа" [ref=e11] [cursor=pointer]:
        - /url: school.html
      - button "Вийти" [ref=e12] [cursor=pointer]
  - complementary [ref=e13]:
    - generic [ref=e14]:
      - heading "Адмін панель" [level=2] [ref=e15]
      - button "✕" [ref=e16] [cursor=pointer]
    - list [ref=e17]:
      - listitem [ref=e18]:
        - button "📋 Нові заявки" [ref=e19] [cursor=pointer]
      - listitem [ref=e20]:
        - button "👥 Живий каталог" [ref=e21] [cursor=pointer]
      - listitem [ref=e22]:
        - button "🐛 Звіти про помилки" [ref=e23] [cursor=pointer]
      - listitem [ref=e24]:
        - button "📁 Архів" [ref=e25] [cursor=pointer]
      - listitem [ref=e26]:
        - button "✉️ Пошта" [ref=e27] [cursor=pointer]
  - button "☰" [ref=e28] [cursor=pointer]
  - main [ref=e29]:
    - heading "Адмін-панель" [level=1] [ref=e30]
    - generic [ref=e32]:
      - heading "Нові заявки" [level=2] [ref=e34]
      - generic [ref=e35]: Завантаження...
```
