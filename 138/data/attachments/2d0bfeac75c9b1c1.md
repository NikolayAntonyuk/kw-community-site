...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e15]:
    - generic [ref=f1e17]:
      ...
      - generic [ref=f1e51]:
        - generic [ref=f1e52]:
          - generic [ref=f1e53]: YouTube (лінк або нікнейм)
          - textbox "YouTube (лінк або нікнейм)" [ref=f1e54]
        - generic [ref=f1e55]: Вебсайт (лінк)
        - textbox "Вебсайт (лінк)" [ref=f1e56]
      - generic [ref=f1e57]:
        - generic [ref=f1e58]: Орієнтовна ціна
        - textbox "Орієнтовна ціна" [ref=f1e59]
      - generic [ref=f1e60]:
        - generic [ref=f1e61]: Додаткові нотатки / Опис
        - textbox "Додаткові нотатки / Опис" [ref=f1e62]
      - button "Відправити заявку" [ref=f1e63] [cursor=pointer]
  - contentinfo [ref=f1e64]:
    - paragraph [ref=f1e65]: Дані каталогу оновлюються через громадську модерацію.
```
