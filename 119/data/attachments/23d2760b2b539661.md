...
- Name: admin-email-features.spec.ts >> Email Features & Admin Panel (New Requirements) >> @T8 should close inaccuracy report modal on Escape key and backdrop click
- Location: tests/e2e/admin-email-features.spec.ts:189:7
