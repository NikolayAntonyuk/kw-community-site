...
- Name: admin.spec.ts >> Admin Panel E2E >> (@T22) should close hamburger menu when tab is selected
- Location: tests/e2e/admin.spec.ts:425:7
...
Call log:
  - waiting for locator('.menu-button, button:has-text("☰")')
