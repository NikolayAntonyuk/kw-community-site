...
- Name: error-reports.spec.ts >> Error Reports Requirements (Звіти про помилки) >> @T11 Auxiliary suggestion field must be hidden during regular edits or creating new cards
- Location: tests/e2e/error-reports.spec.ts:99:7
